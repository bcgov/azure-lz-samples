...
| <a name="input_allow_rdp_shortpath_with_private_link"></a> [allow\_rdp\_shortpath\_with\_private\_link](#input\_allow\_rdp\_shortpath\_with\_private\_link) | (Optional) Whether RDP Shortpath with Private Link is allowed. | `string` | `"Disabled"` | no |
...
| <a name="input_deployment_scope"></a> [deployment\_scope](#input\_deployment\_scope) | (Optional) Deployment scope for the host pool. | `string` | `"Geographical"` | no |
| <a name="input_description"></a> [description](#input\_description) | (Optional) Description for the host pool. | `string` | `null` | no |
| <a name="input_direct_udp"></a> [direct\_udp](#input\_direct\_udp) | (Optional) Direct UDP transport setting. | `string` | `"Default"` | no |
...
| <a name="input_managed_private_udp"></a> [managed\_private\_udp](#input\_managed\_private\_udp) | (Optional) Managed private UDP transport setting. | `string` | `"Default"` | no |
| <a name="input_management_type"></a> [management\_type](#input\_management\_type) | (Optional) Host pool management type. | `string` | `"Standard"` | no |
...
| <a name="input_private_endpoints"></a> [private\_endpoints](#input\_private\_endpoints) | (Optional) Private endpoints to create for the host pool. | <pre>list(object({<br/>    subnet_id         = string<br/>    subresource_names = list(string)<br/>  }))</pre> | `[]` | no |
| <a name="input_public_network_access"></a> [public\_network\_access](#input\_public\_network\_access) | (Optional) Public network access mode for the host pool. | `string` | `"Disabled"` | no |
| <a name="input_public_udp"></a> [public\_udp](#input\_public\_udp) | (Optional) Public UDP/STUN transport setting. | `string` | `"Default"` | no |
...
| <a name="input_relay_udp"></a> [relay\_udp](#input\_relay\_udp) | (Optional) Relay/TURN UDP transport setting. | `string` | `"Default"` | no |
...
| <a name="input_resource_group_name"></a> [resource\_group\_name](#input\_resource\_group\_name) | (Required) The resource group name where the host pool will be created. | `string` | n/a | yes |
| <a name="input_ring"></a> [ring](#input\_ring) | (Optional) Ring number for the host pool. | `number` | `null` | no |
...
| <a name="input_vm_template"></a> [vm\_template](#input\_vm\_template) | (Optional) VM template JSON for session host configuration scenarios. | `string` | `null` | no |
...
| <a name="output_private_endpoint_ids"></a> [private\_endpoint\_ids](#output\_private\_endpoint\_ids) | Private endpoint IDs created for the host pool. |
