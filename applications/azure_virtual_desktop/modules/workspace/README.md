...
| <a name="input_private_endpoints"></a> [private\_endpoints](#input\_private\_endpoints) | (Optional) Private endpoints to create for the workspace. | <pre>map(object({<br/>    subnet_id         = string<br/>    subresource_names = list(string)<br/>  }))</pre> | `{}` | no |
...
| <a name="output_private_endpoint_ids"></a> [private\_endpoint\_ids](#output\_private\_endpoint\_ids) | Private endpoint IDs created for the workspace. |
<!-- END_TF_DOCS -->
